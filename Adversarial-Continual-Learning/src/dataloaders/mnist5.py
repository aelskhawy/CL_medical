...
class iMNIST(datasets.MNIST):
    ...
    def __init__(self, root, classes, memory_classes, memory, task_num, train, transform=None, target_transform=None, download=True):
        ...
        # the extra label zero is associated with the ‘fake’ task label paired with randomly
        # generated noise features, thats why we add +1 to td
...
class DatasetGen(object):
    ...
    def __init__(self, args):
        ...
        # t = task number, int( / ) = num of classes in this task
