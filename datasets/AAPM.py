...
def get_all_preprocessed_patients(split: str, opt=None) -> List:
    """
    ...
    # csv_path = Path(opt.data_root_aapm) / "multi_organ_data.csv"  # dgx
    csv_path = Path("/home/abel@local.tmvse.com/skhawy/Canon/Code/ADP_ContinualLearning/data/Training") / "multi_organ_data.csv"
    ...
    # for vis purpose
    patients_of_intrest = ["LCTSC-Test-S2-104"]
...
class AAPMSinglePatient(Dataset):
    ...
    def prepare_files(self):
        ...
        # if self.args.vis_seg: # for visulaization purpose
